...
public class HeapPage implements Page {
    ...
    public boolean getSlot(int i) {
        // some code goes here
        // Find which 32-bit integer contains the bit for slot i
        int headerIndex = i / 32;
        // Find which bit within that integer represents slot i
        int bitIndex = i % 32;
        
        // Extract the bit and return true if it's set (1)
    ...
    public Iterator<Tuple> iterator() {
        ...
        return new Iterator<Tuple>() {
            ...
            public boolean hasNext() {
                ...
                while (currentSlot < numSlots && !getSlot(currentSlot)) {
                    currentSlot++;
                }
                return currentSlot < numSlots;
            }
            ...
            public Tuple next() {
                ...
                Tuple tuple = tuples[currentSlot];
                currentSlot++;
                return tuple;
            }
